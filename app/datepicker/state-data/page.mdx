...
The **time** array consists of objects featuring properties like **$date**, **disabled**, **now**, **selected**, and **value**. For adjusting the time format, properties like [hour12, hour, monute and second](/datepicker/locale-configuration#hour-monute-second-and-hour12) within the Locale configuration can be utilized.
