...
It provides behavioral and accessibility implementations for all sorts of calendars, date pickers, and time pickers.

## Features

- Small in size.
- No dependencies.
- [Modular design](/modular-hooks): You can use as little code as possible.
