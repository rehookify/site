...
The library is providing a set of context hooks that have same APIs and prefixed with "Context".
They used under the `DatePickerStateProvider` component it was shown in the [modular hooks solution](/datepicker/using-modular-hooks) guide.
